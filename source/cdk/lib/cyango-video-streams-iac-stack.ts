...
interface CyangoVideoStreamsIacProps extends cdk.StackProps {
  /**
   * stage
   * @default dev 
   */
...
export class CyangoVideoStreamsIac extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props: CyangoVideoStreamsIacProps) {
    ...
    */
    this.templateOptions.description = 'Cyango Video Streams';
    /**
    ...
    */
    const source = new s3.Bucket(this, 'Source', {
      bucketName: `${stage}-cyango-video-in`,
      serverAccessLogsBucket: logsBucket,
      serverAccessLogsPrefix: `${stage}-source-bucket-logs/`,
      encryption: s3.BucketEncryption.S3_MANAGED,
      publicReadAccess: false,
      blockPublicAccess: s3.BlockPublicAccess.BLOCK_ALL,
      cors: [
    ...
    */
    const destination = new s3.Bucket(this, 'Destination', {
      bucketName: `${stage}-cyango-video-out`,
      serverAccessLogsBucket: logsBucket,
      serverAccessLogsPrefix: `${stage}-destination-bucket-logs/`,
      encryption: s3.BucketEncryption.S3_MANAGED,
      publicReadAccess: false,
      blockPublicAccess: s3.BlockPublicAccess.BLOCK_ALL,
      cors: [
    ...
    */
    const cachePolicy = new cloudfront.CachePolicy(this, 'VODCachePolicy', {
      cachePolicyName: `${stage}VODCachePolicy`,
    ...
    */
    ...
    /**
     * Add ffmpeg layer to Job submit Lambda function
     */
    const ffmpeglayerArn = `arn:aws:lambda:eu-west-1:733934826949:layer:ffmpeg:1`;
    const layer = lambda.LayerVersion.fromLayerVersionArn(this, `LayerFromArn`, ffmpeglayerArn);
    jobSubmit.addLayers(layer);
